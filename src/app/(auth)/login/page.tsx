...
export default async function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_left,_#ccfbf1,_transparent_38%),linear-gradient(to_bottom,_#f8fafc,_#ecfeff)] px-5 py-10">
