...
export function CreateClassroomForm() {
  ...
  return <form action={action} className="mt-7 space-y-5 rounded-2xl bg-white/90 shadow-md shadow-teal-100/60 ring-1 ring-teal-100 p-6 shadow-sm sm:p-8">
    ...
    <button disabled={pending} className="w-full rounded-xl bg-teal-600 px-5 py-3 font-bold text-white disabled:opacity-50">{pending ? "Đang tạo lớp..." : "Tạo lớp"}</button>
  </form>;
}
